            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = registers;
                        return [4 /*yield*/, commands_1.registerRead(this.device, this.address, registers_1.ctrl_meas)];
                    case 1:
                        _a.ctrl_meas = _c.sent();
                        _b = registers;
                        return [4 /*yield*/, commands_1.registerRead(this.device, this.address, registers_1.config)];
                    case 2:
                        _b.config = _c.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, commands_1.registerWrite(this.device, this.address, registers_1.ctrl_meas, registers.ctrl_meas)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, commands_1.registerWrite(this.device, this.address, registers_1.config, registers.config)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
